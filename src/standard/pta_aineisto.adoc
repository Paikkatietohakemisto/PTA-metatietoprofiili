...
|*Suositus{nbsp}{x-suositus-maantieteellinen-kattavuus-nimi-nro}*  | `<<#suositus-maantieteellinen-kattavuus-nimi,vaatimukset/suositus-maantieteellinen-kattavuus-nimi>>` +
Maantietellinen kattavuus suositellaan annettavaksi myös paikannimien avulla.
...
ilmaisemiseen. Yksi sallituista vaihtoehdoista on monenkielisten metatietojen antaminen samassa
meatietodokumentissa tekstikenttien dynaamisen uudelleentyypittämisen avulla (vaihtoehto 3).

PTA-aineistojen suhteen monikielisen metatietosisällön tarjoamista koskevaa INSPIRE-vaatimusta tiukennetaan
siten, että mahdolliset käännökset metatiedon kielellä ilmaistuille sisällöille esitetään aina samassa
metatietodokumentissa alkuperäisen sisällön kanssa TG Requirement C.4 vaihtoehdon 3 mukaisesti.
...
[NOTE]
====
INSPIRE-hakupalvelujen teknisen ohjeen <<TG_DISC_31>> vaatimuksen "Implementation Requirement 24" mukaan
INSPIRE-vaatimusten mukaisen CSW-hakupalvelurajapinnan tulee tukea luonnollisen kielen valintaa
erityisen kielivalintapyyntöparametrin avulla. Mikäli palvelun käyttäjä antaa palvelun tukeman kielen
mukaisen kielivalintaparametrin osana palvelupyyntöä, tulee palvelun palauttaa vastauksen luonnollisella
kielellä kuvattujen kenttien arvot pyydetyllä kielellä.

Tämän vaatimuksen ei katsota olevan ristiriidassa PTA-metatietoprofiilin vaatimuksen
<<#vaatimus-metatiedon-kieli,vaatimukset/vaatimus-metatiedon-kieli>> kanssa, sillä
CSW-palvelu voi muokata palautettavaa metatietodokumenttia siten, että pyydetynkielinen
sisältö palautetaan metatietokenttien oletussisältönä ja metatiedon kieli -kentän arvo
asetetaan pyydetyn kielen mukaiseksi. Kaikkien tarjottavien metatiedon
kieliversioiden tekstisisältöjen kuvaaminen samassa siirtotietorakenteessa helpottaa
metatietojen pysymistä yhtenäisinä, kun kukin aineisto kuvataan vain yhdellä
metatietotietueella.
====
...
esimerkiksi Paikkatietoalustan tuottamalle kyseisen aineiston tietokorttisivulle.
...
vaatimuksenmukaisuus-viittausta osana laatutietoja (ks. <<#suositus-yksityiskohtaisuus-luokittelu,vaatimukset/suositus-yksityiskohtaisuus-luokittelu>>)
====
...
elementeissä, jotka palautuvat XPath-kyselyn
...
==== Aineiston maantieteellinen kattavuus
INSPIRE-vaatimus TG Requirement C.19 edellyttää aineiston maantieteellisen kattavuuden kuvaamista rajaavana
suorakaiteena (bounding box). Aineiston kattaman alueen tai alueiden kuvaaminen myös sanallisesti helpottaa
aineiston löytämistä, mikäli alueiden nimiä käytetään hakusanoina. Alueiden nimien avulla voidaan myös helposti
tarkentaa pelkällä suorakaiteella ilmaistavan aineiston kohdealueen kuvausta.

[#suositus-maantieteellinen-kattavuus-nimi]
[width="90%",cols="2,6"]
|===
|*Suositus{nbsp}{x-suositus-maantieteellinen-kattavuus-nimi-nro}* | `vaatimukset/suositus-maantieteellinen-kattavuus-nimi` +
PTA-aineistojen suhteen suositellaan hakutulososuvuuden parantamiseksi lisäksi
kuvaamaan aineiston maantieteellinen kattavuus merkkijonomuotoisina aineiston kattamien hallinnollisten alueiden
niminä. Alueiden nimet susitellaan esitettäviksi XPath-kyselyn
`/pass:[*]/gmd:identificationInfo[1]/pass:[*]/gmd:extent/pass:[*]/gmd:geographicElement/pass:[*]/gmd:geographicIdentifier/pass:[*]/gmd:code`
palauttamien elementtien avulla.

Alueen nimi ilmaistaan `gmd:code`-elementin sisällä ensisijaisesti
merkkijonona ja viittauksena ulkoiseen koodilistaan tai alueen kuvaukseen (`gmx:Anchor`) ja toissijaisesti vain
merkkijonona (joko monikielinen nimi ks. <<#vaatimus-metatiedon-kieli,vaatimukset/vaatimus-metatiedon-kieli>> tai vain yksi
metatietokuvauksen kielinen nimi, `gco:CharacterString`). Kukin alueen nimi annetaan omana `gmd:geographicElement`-elementtinään.
|===

Käytettävien hallinnollisten alueiden nimien tulee olla alueiden virallisia nimiä, ja nimihierarkian taso tulee
valita aineiston tarkkuuden mukaisesti. Esimerkiksi yhden kaupungin aluetta koskevassa aineistossa on mahdollisesti
mielekästä käyttää kaupungin nimen lisäksi kaupungienosien tai osa-alueiden nimiä. Useita eri
Suomen paikkakunnilla sijaitsevia kohteita koskevassa aineistossa taas olisi suositeltavaa antaa kaikkien kyseisten
paikkakuntien nimet.

.Esimerkki{nbsp}{counter:example}: Aineiston maantieteellinen kuvaus sekä suorakaiteen että kahden paikannimen avulla
[source,xml]
----
     ...
     <gmd:geographicElement>
        <gmd:EX_GeographicDescription>
           <gmd:geographicIdentifier>
              <gmd:MD_Identifier>
                 <gmd:code>
                    <gmx:Anchor xlink:href="https://sws.geonames.org/9610677/about.rdf">Helsinki</gmx:Anchor>
                 </gmd:code>
              </gmd:MD_Identifier>
           </gmd:geographicIdentifier>
        </gmd:EX_GeographicDescription>
     ...
     <gmd:geographicElement>
        <gmd:EX_GeographicDescription>
           <gmd:geographicIdentifier>
              <gmd:MD_Identifier>
                 <gmd:code>
                    <gmx:Anchor xlink:href="https://sws.geonames.org/643261/about.rdf">Padasjoki</gmx:Anchor>
                 </gmd:code>
              </gmd:MD_Identifier>
           </gmd:geographicIdentifier>
        </gmd:EX_GeographicDescription>
     ...
     <gmd:geographicElement>
       <gmd:EX_GeographicBoundingBox>
          <gmd:westBoundLongitude>
             <gco:Decimal>24.60851</gco:Decimal>
          </gmd:westBoundLongitude>
          <gmd:eastBoundLongitude>
             <gco:Decimal>25.13732</gco:Decimal>
          </gmd:eastBoundLongitude>
          <gmd:southBoundLatitude>
             <gco:Decimal>60.3694</gco:Decimal>
          </gmd:southBoundLatitude>
          <gmd:northBoundLatitude>
             <gco:Decimal>61.35062</gco:Decimal>
          </gmd:northBoundLatitude>
       </gmd:EX_GeographicBoundingBox>
     </gmd:geographicElement>
  </gmd:EX_Extent>
...
PTA-vaatimuksenmukaisuusluokkien sisältävien laatutestien tuloksista, mikäli näitä testejä on ajettu kyseiselle
aineistolle. Metatiedon tulee sisältää yksi
...
[./gmd:specification/pass:[*]/gmd:title/gmx:Anchor/starts-with(@xlink:href,'http://paikkatiedot.fi/def/pta-aineisto/vaatimukset/')]
     ...
     <gmd:result>
        <gmd:DQ_ConformanceResult>
           <gmd:specification>
              <gmd:CI_Citation>
                 <gmd:title>
                    <gmx:Anchor xlink:href="http://paikkatiedot.fi/def/pta-aineisto/vaatimukset/luokka-topologia">Topologia</gmx:Anchor>
                 </gmd:title>
                 <gmd:date>
                    <gmd:CI_Date>
                       <gmd:date>
