...
PTA-aineisto:: Tietoaineisto, jonka käytöstä osana Paikkatietoalustan palveluja on sovittu Maanmittauslaitoksen ja
tiedontuottajan välillä, ja jolle on yhteisesti sovittu erityinen PTA-aineisto -status.
