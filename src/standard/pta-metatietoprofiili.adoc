...
=== Tunnisteet
Tässä asiakirjassa kuvattujen vaatimusten kokonaisuuteen viitataan absoluuttisella URI-tunnuksella
...
PTA-aineisto:: Tietoaineisto, jonka käytöstä osana Paikkatietoalustan palveluja on sovittu Paikkatietoalustan ja
tiedontuottajan välillä, ja jolle on annettu erityinen PTA-aineisto -status.
