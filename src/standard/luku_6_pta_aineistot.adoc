...
yksilöivä merkkijonomuotoinen UUID-tunnus. XPath-kyselyn `/pass:[*]/gmd:fileIdentifier`
...
luku 2.3.7 "Conditions applying to access and use"). Näissä luvuissa kuvattu TG Requirement C.17 vaatii, että
...
lisenssiehtojen tai muiden sopimusteknisten rajoittavien vaatimusten ilmaisemiseen.
